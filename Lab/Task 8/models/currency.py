# Модель информации валюты
class Currency:
    def __init__(self, char_code: str, num_code: str, name: str, value: float, nominal: int, valute_id: int | None = None):
        self.__num_code: str = num_code
        self.__char_code: str = char_code
        self.__name: str = name
        self.__value: float = value
        self.__nominal: int  = nominal
        self.__valute_id: int | None = valute_id
